...
func TestImports(t *testing.T) {
	...
	aBar := "github.com/swiftcarrot/dashi/gqlgen/codegen/templates/testdata/a/bar"
	bBar := "github.com/swiftcarrot/dashi/gqlgen/codegen/templates/testdata/b/bar"
	mismatch := "github.com/swiftcarrot/dashi/gqlgen/codegen/templates/testdata/pkg_mismatch"
	...
	t.Run("lookup by type", func(t *testing.T) {
		...
		pkg := types.NewPackage("github.com/swiftcarrot/dashi/gqlgen/codegen/templates/testdata/b/bar", "bar")
	...
	t.Run("string printing for import block", func(t *testing.T) {
		...
		require.Equal(
			t,
			`"github.com/swiftcarrot/dashi/gqlgen/codegen/templates/testdata/a/bar"
bar1 "github.com/swiftcarrot/dashi/gqlgen/codegen/templates/testdata/b/bar"
turtles "github.com/swiftcarrot/dashi/gqlgen/codegen/templates/testdata/pkg_mismatch"`,
			a.String(),
		)
	})
	...
	t.Run("aliased imports will not collide", func(t *testing.T) {
		...
		require.Equal(t, `abar "github.com/swiftcarrot/dashi/gqlgen/codegen/templates/testdata/a/bar"
bbar "github.com/swiftcarrot/dashi/gqlgen/codegen/templates/testdata/b/bar"`, a.String())
	})
